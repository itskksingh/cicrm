export const SAFE_REDIRECT_MESSAGE = "Iska sahi diagnosis doctor hi kar sakte hain 🙏\nKya main aapke liye appointment book kar du?";

export const DOCTOR_REDIRECT_MESSAGE = "Aapke symptoms doctor ko dikhana zaroori hai.\nKya main appointment schedule kar du?";
